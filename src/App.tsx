...
const defaultPinnedPages: PinnedPage[] = [
  ...
  { id: 'drivewyze', label: 'Drivewyze', url: 'https://login.go.fleetworthy.com/bpfleetsprod.onmicrosoft.com/b2c_1a_signup_signin_hub/oauth2/v2.0/authorize?client_id=9cf96f0b-0c1d-4a11-aae4-6cdf0accfd01&scope=openid%20profile%20offline_access&redirect_uri=https%3A%2F%2Fhub.drivewyze.com&client-request-id=019c4a7b-8a7d-71ea-a342-819c98032025&response_mode=fragment&client_info=1&nonce=019c4a7b-8a7e-7137-b442-2c46e1fd7928&state=eyJpZCI6IjAxOWM0YTdiLThhN2UtN2U1Ny05NWYwLThkMTc2MDkyZTIwZiIsIm1ldGEiOnsiaW50ZXJhY3Rpb25UeXBlIjoicmVkaXJlY3QifX0%3D&x-client-SKU=msal.js.browser&x-client-VER=4.12.0&response_type=code&code_challenge=J8oMhFZ_JRevXWdSpK2ypmmA6MEdSpR_gHPFHDrns_8&code_challenge_method=S256', icon: (
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
